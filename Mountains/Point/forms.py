                        ...
                        # СОЗДАНИЕ ФОРМЫ ДЛЯ МОДЕЛЕЙ ПРИЛОЖЕНИЯ Point И ВАЛИДАЦИЯ ДАННЫХ В ФОРМАХ
                                 # Формы используются для обработки вводимых данных
...
#            'status',                          # Я установил статус "new" по умолчанию (см. class PointCreate во вьюхе)
        ]
...
########################################################################################################################
                                                 # ВАЛИДАЦИЯ
    # Переопределяем метод clean в форме:
    def clean(self):
